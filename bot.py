...
from core.analytics import calculate_income, calculate_expense, expense_stats, top_category
...
def home():
    ...
    all_history = data["personal"]["history"] + data["business"]["history"]
    ...
    top_exp = top_category(personal_stats)
